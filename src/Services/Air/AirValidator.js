...
module.exports = {
  ...
  AIR_PRICE: compose(
    ...
    transform(
      transformers.setBusinessFlag,
      // transformers.processPassengersAirPrice,
      transformers.setPassengersAge,
      transformers.setGroupsForSegments,
      transformers.setHasFareBasisFlag,
      transformers.processRawSegment
    )
  ),
  ...
  AIR_REQUEST_BY_PNR: compose(validate(validators.pnr), transform()),
  ...
  AIR_FLIGHT_INFORMATION: compose(validate(validators.flightInfo), transform()),
  ...
  AIR_EMD_ITEM: compose(
    validate(validators.paramsIsObject, validators.emdNumber),
    transform()
  ),
};
